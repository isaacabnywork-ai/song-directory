    ...
    `}>
      ...
      <div className="p-4 border-b border-gray-200 dark:border-[#333] flex items-center justify-between bg-gray-50/80 dark:bg-[#181818]">
        <div className="flex items-center gap-2.5">
          ...
          <img src="/logo.png" alt="SVC Logo" className="w-7 h-7 object-contain rounded-lg bg-white p-0.5 shadow-sm shrink-0 border border-gray-200 dark:border-gray-700" />
          <div>
